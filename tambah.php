...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tasks (user_id, judul, deskripsi, status, prioritas, tanggal_mulai, tanggal_selesai) 
              VALUES ('$user_id', '$judul', '$deskripsi', '$status', '$prioritas', '$tanggal_mulai', '$tanggal_selesai')";
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-plus me-2"></i>Tambah Todolist</h3>
            </div>
            <div class="card-body">
                <form method="POST">
                    <div class="mb-3">
